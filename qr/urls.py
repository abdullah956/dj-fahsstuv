...
from .views import get_certificate_data2,certificate_list_view2,get_certificate_data,certificate_detail,certificate_form_view, certificate_list_view, download_certificate_pdf,login_view, signup_view, logout_view
